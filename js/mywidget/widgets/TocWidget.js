    ...
    function (declare, array, query, domAttr, domStyle, on, lang, CheckBox, _BaseWidget, _WidgetsInTemplateMixin, template) {
        return declare([_BaseWidget, _WidgetsInTemplateMixin], {
            ...
            buildLayerList: function (layer) {
                ...
                var currentHTML = "";
                var expandImageUrl = require.toUrl("mywidget/widgets/assets/images/expand.bmp");
                var blankImageUrl = require.toUrl("mywidget/widgets/assets/images/blank.bmp");
            ...
            toggleLayer: function (evt) {
                ...
                if (layerDiv.style.display == 'block') {
                    icon.src = require.toUrl("mywidget/widgets/assets/images/expand.bmp");
                    layerDiv.style.display = 'none';
                }
                else {
                    icon.src = require.toUrl("mywidget/widgets/assets/images/close.bmp");
